...
We define $\xi$ to explore the whole tree of nodes with one constant and one none-constant operand, and returns every node that was not constant.bot
\begin{center}
$\xi(a) := 
\left\{
	\begin{array}{l}
